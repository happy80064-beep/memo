...
REMAINING = [
    {
        "source": "/people/yang-gui-hua",
        "target": "/people/yang-guihua",
        "replacements": {"杨桂花": "杨桂花"}  # 同名，不需要替换
    },
    {
        "source": "/people/李佳泽",
        "target": "/people/li-jiaze",
        "replacements": {"李佳泽": "李佳泽"}  # 同名，不需要替换
    },
    {
        "source": "/people/li-junjie",
        "target": "/people/li-jun-jie",
        "replacements": {"李俊杰": "李俊杰"}  # 同名，不需要替换
    }
]
